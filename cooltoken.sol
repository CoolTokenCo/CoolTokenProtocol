...
contract CoolToken is ERC20, Ownable {
    ...
    uint256 public maxWalletLimit = 10 * 10**8 * 10**18;
    uint256 public maxTxAmount = 10 * 10**7 * 10**18; 
    ...
    address payable public _devWallet = payable(address(0x39dd236339C25F0C5131FDE69560fb3D214d24BC)); // Dev Wallet
    address payable public _projectWallet = payable(address(0xb4fB57C29F7bD8b47772EBE9824e2eA40a122aBA)); // Project Wallet
    ...
    constructor() ERC20("Cool Token", "COOL") {
        ...
        */
        _mint(owner(), 10 * 10**9 * (10**18)); // 10 billion supply
